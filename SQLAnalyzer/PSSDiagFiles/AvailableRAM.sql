...
SELECT 
	...
	total_physical_memory_kb/CAST(1024 AS BIGINT), 
	available_physical_memory_kb/CAST(1024 AS BIGINT), 
	0,
	total_page_file_kb / CAST(1024 AS BIGINT),
	available_page_file_kb /CAST(1024 AS BIGINT)
